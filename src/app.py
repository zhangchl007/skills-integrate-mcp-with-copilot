...
def signup_for_activity(activity_name: str, email: str, authorization: str = Header(default=None)):
...
def unregister_from_activity(activity_name: str, email: str, authorization: str = Header(default=None)):
